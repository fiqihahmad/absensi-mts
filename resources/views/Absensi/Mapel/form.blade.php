...
<div class="card">
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('absensi.mapel.store') }}">
            @csrf
            ...
            <div class="row mt-3 mb-3 align-items-center">
                ...
                <div class="col-sm-10">
                    <input type="date" class="form-control" id="tanggal" name="tanggal" value="{{ request('tanggal') ?? date('Y-m-d') }}" required>
                </div>
            </div>
            ...
            <button type="submit" name="btnSimpanAbsensi" class="btn btn-primary float-end">Simpan Absensi</button>
        </form>
    </div>
</div>
@endsection